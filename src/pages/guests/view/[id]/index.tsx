        ...
        {isLoading ? (
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem label="Insurance Plan Id" text={data?.insurance_plan_id} />

                <FormListItem label="Appointment Id" text={data?.appointment_id} />

                <FormListItem label="Medical Record Id" text={data?.medical_record_id} />
