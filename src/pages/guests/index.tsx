...
export function GuestListPage(props: GuestListPageProps) {
  ...
  const columns: ColumnType[] = [
    { id: 'insurance_plan_id', header: 'Insurance Plan Id', accessorKey: 'insurance_plan_id' },
    { id: 'appointment_id', header: 'Appointment Id', accessorKey: 'appointment_id' },
    { id: 'medical_record_id', header: 'Medical Record Id', accessorKey: 'medical_record_id' },
